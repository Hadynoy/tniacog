  ...
  return (
    <Layout>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        <h2 className="text-3xl font-bold text-gray-900 mb-10 text-center will-change-transform">
          Church Moments
        </h2>
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
          {images.map((img, index) => (
            <div
              key={index}
              className="overflow-hidden rounded-lg shadow-lg hover:shadow-xl transition-shadow cursor-pointer will-change-transform"
      ...
      {/* Lightbox Modal */}
      {selectedIndex !== null && (
        <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-50 will-change-transform transform-gpu">
          <button
          ...
          <img
            ...
            className="max-h-[80vh] max-w-[90vw] rounded-lg shadow-lg will-change-transform"
          />
